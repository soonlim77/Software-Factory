...
{
    public class JustInTimeShippingFacade : IGenericCommand<IResult, ShippingDetailInfo>
    {

        private static JustInTimeShippingFacade instance=null;
        private JustInTimeShippingFacade() { }
